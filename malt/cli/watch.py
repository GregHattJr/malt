...
def callback(parser):
    ...
    # We need to check if the `malt` package has been executed:
    # 1. Directly, as `python3 /path/to/malt/package`.
    # 2. As an installed package on the import path, `python3 -m malt`.
    # 3. Via an entry script, `malt`.
